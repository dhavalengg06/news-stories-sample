...
open class RxSchedulersOverrideRule : TestRule {
	...
	private val mRxAndroidSchedulersHook: Function<Callable<Scheduler>, Scheduler> = Function<Callable<Scheduler>, Scheduler> { scheduler }

	private val mRxJavaImmediateScheduler: Function<Scheduler, Scheduler> = Function<Scheduler, Scheduler> { scheduler -> scheduler }
